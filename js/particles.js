window.initParticles = () => {
    ...
    const animate = () => {
        ...
        if (state === 'BEAM') {
            ...
            const beamSpeedPx = Math.max(10, width * 0.009);
